...
export default function Angkatan2526() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
    ...
    <div style={container}>
      ...
      <div style={title}>
        <h1 style={{ fontSize: "clamp(24px,5vw,42px)", fontWeight: 700 }}>
          ...
          <span style={{ color: "#22d3ee" }}>2025–2026</span>
        </h1>
      </div>
      ...
      <div style={grid2}>
        <motion.div style={card} {...motionCard}>
          <img src="KAHIM.JPG" style={imgStyle} />
          <div style={jabatan}>KETUA HIMATIF</div>
          <div style={nama}>ADI MUCHAMAD RAFLY</div>
        </motion.div>

        <motion.div style={card} {...motionCard}>
          <img src="WAKAHIM.JPG" style={imgStyle} />
          <div style={jabatan}>WAKIL KETUA</div>
          <div style={nama}>MOCH DIVA MARTIN</div>
        </motion.div>
      </div>
      ...
      <div style={grid2}>
        <motion.div style={card} {...motionCard}>
          <img src="SEKRE.JPG" style={imgStyle} />
          <div style={jabatan}>SEKRETARIS</div>
          <div style={nama}>NURFAHIRA</div>
        </motion.div>

        <motion.div style={card} {...motionCard}>
          <img src="BENDAHARA.JPG" style={imgStyle} />
          <div style={jabatan}>BENDAHARA</div>
          <div style={nama}>SYABILA MAHARANI</div>
        </motion.div>
      </div>
        ...
        {[
          {
            ...
            kepala: "AHMAD SYAHPUTRA",
            staf: ["RIFKI MAFTUH FUADI", "ADIB LABIB H", "NAZWA SAHARANI"],
          },
          {
            img: "PELITBANG.JPG",
            dept: "DEPARTEMEN PELITBANG",
            kepala: "MOH IKHSAN PRAMANA",
            staf: ["SURYA SUGIRI", "TIO", "AHMAD ILYAS M", "LINDA"],
          },
          {
            img: "PSDM.jpeg",
            dept: "DEPARTEMEN PSDM",
            kepala: "ZULFIKAR ZULKARNAEN",
            staf: ["MUHAMMAD MUKLIS", "ANGELINA ALIFAH P", "PAREL PERDIANSAH"],
          },
        ].map((d, i) => (
